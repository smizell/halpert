...
var Converter = function(formats) {
  ...
  // Given a representation and a media type, this should parse 
  // the representation.
  this.parse = function(rep, mediaType) {
    return this.formats[mediaType].parser(rep);
  };
  ...
  this.convertFrom = function(rep, mediaType) {
    this.parsed = this.formats[mediaType].parser(rep);
    return this;
  };
  ...
  this.to = function(mediaType) {
    return this.build(this.parsed, mediaType);
  };
};
...
var Halpert = module.exports = function() {
  ...
  // For registering a media type for Halpert to parse from
  // or build to. 
  ...
  // Wrapper for `parse` method on `Converter` object
  this.parse = function(rep, mediaType) {
    return new Converter(this.formats).parse(rep, mediaType);
  };
